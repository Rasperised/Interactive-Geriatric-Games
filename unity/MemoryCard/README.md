...
Memory Card is a cognitive matching game designed for elderly users, focusing on memory recall, visual recognition, and sustained attention. The game presents a set of face-down cards that must be flipped and matched in pairs.
...
### Key Features
- Allows users to upload exactly six custom images and play using their own selected images  
